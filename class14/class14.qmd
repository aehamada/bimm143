...
Cell cycle / cell cycle, mitotic. This is different from the KEGG results, since the described pathways in Reactome seem to be a little more general. Also, the Reactome may consider different variables.